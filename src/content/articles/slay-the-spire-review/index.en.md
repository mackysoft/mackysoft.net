---
title: "Why Is Slay the Spire So Fun? [From a Roguelike Developer's Perspective]"
description: "Slay the Spire is a roguelike deck-building card game. I also make roguelike games myself, so in this article I look at Slay the Spire from the perspective of a roguelike developer."
...
<table><tbody><tr><td>Unknown</td><td>An event may happen here.</td></tr><tr><td>Merchant</td><td>A merchant. You can buy cards and other things. The inventory is random.</td></tr><tr><td>Treasure</td><td>A treasure chest. You can obtain gold, cards, and power-up items. What you get is random.</td></tr><tr><td>Rest</td><td>You can either recover HP or upgrade a card. (You choose one.)</td></tr><tr><td>Enemy</td><td>A regular enemy. You get a reward if you defeat it. The enemy that appears is random.</td></tr><tr><td>Elite</td><td>An elite enemy. It is risky to fight, but the reward is better if you win. The enemy that appears is random.</td></tr></tbody></table>
...
Looking at the [Wiki](https://slay-the-spire.fandom.com/wiki/Events), there are currently 52 events, but in general there are not many that are just **"one-sided losses for the player."**
...
"Contrast" means having clear peaks and valleys. Because an uninteresting pattern exists, the exciting choices feel even more exciting, and **you end up wanting to hit the Play button again and again**. That is one possible interpretation. (Reference: [How Contrast Makes Games Fun [Game Design]](/articles/gamedesign-contrast-cedec2018/))
...
-   [An interview with the developers of the indie classic Slay the Spire, about the art of balancing the game. "How can players adapt to what they are given?" Forcing players to work with one-of-a-kind tactical situations](https://news.denfaminicogamer.jp/interview/200117b)
